...
/*
 * Visar uppgifter med status "new".
 * Användaren kan tilldela en medlem (med rätt roll) till en uppgift, vilket uppdaterar status till "in progress".
 */
const NewTaskList = ({ tasks = [], members = [], setMessage, onOpenModal }) => {
    ...
    <div>
        ...
        return (
          <div key={task.id} className="task-card">
            ...
            {/* Öppnar redigeringsmodal, finns i InProgressTaskList och FinishedTaskList också */}
